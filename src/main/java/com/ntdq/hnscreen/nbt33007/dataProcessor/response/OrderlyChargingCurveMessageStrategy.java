...
/**
 * @Description : 下发有序充电曲线
 * @Author : Kang
 * @Date : 2023/4/20 21:25
 * @Version : 1.0
 */

public class OrderlyChargingCurveMessageStrategy implements ReceiveMessageStrategy {
    ...
    public void receiveMessage(Channel channel, MessageDetail messageDetail) {
        log.info("-----------Message:下发有序充电曲线 begin------------");
