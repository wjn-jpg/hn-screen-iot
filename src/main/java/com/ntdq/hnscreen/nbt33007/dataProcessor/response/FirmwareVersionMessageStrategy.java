...
/**
 * @Description : 主站主动下发固件版本
 * @Author : Kang
 * @Date : 2023/4/20 21:35
 * @Version : 1.0
 */

public class FirmwareVersionMessageStrategy implements ReceiveMessageStrategy {
    ...
    public void receiveMessage(Channel channel, MessageDetail messageDetail) {
        log.info("-----------Message:主站主动下发固件版本 begin------------");
        ...
        log.info("------------Message:主站主动下发固件版本 end-------------");
    }
}
