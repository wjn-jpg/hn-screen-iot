...
/**
 * @Description : 主站下发总召唤命令
 * @Author : Kang
 * @Date : 2023/4/20 20:09
 * @Version : 1.0
 */
public class TotalCallMessageStrategy implements ReceiveMessageStrategy {
