...
/**
 * @Description : 主动上送故障告警详情
 * @Author : Kang
 * @Date : 2023/4/20 21:28
 * @Version : 1.0
 */

public class FaultAlarmDetailsMessageStrategy implements ReceiveMessageStrategy {
    ...
    public void receiveMessage(Channel channel, MessageDetail messageDetail) {
        log.info("-----------Message:主动上送故障告警详情 begin------------");
        ...
        log.info("------------Message:主动上送故障告警详情 end-------------");
    }
}
